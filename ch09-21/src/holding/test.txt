...
public class TextFile extends ArrayList<String> {
    ...
    public static void main(String[] args) {
        String file = read("src/holding/TextFile.java");
        write("src/holding/test.txt", file);
        TextFile text = new TextFile("src/holding/test.txt");
        text.write("src/holding/test2.txt");
        // Break into unique sorted list of words:
        TreeSet<String> words = new TreeSet<String>(
                new TextFile("src/holding/TextFile.java", "\\W+"));
